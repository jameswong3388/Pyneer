...
def create(table, data, file='databases/databases.json'):
    """
...
def read(table, queried_key , file='databases/databases.json'):
    """
...
def update(table, data , file='databases/databases.json'):
    """
...
def delete(table, data, file='databases/databases.json'):
    """
...
def create_table(table, file='database/databases.json'):
    """
...
def delete_table(table, file='database/databases.json'):
    """
